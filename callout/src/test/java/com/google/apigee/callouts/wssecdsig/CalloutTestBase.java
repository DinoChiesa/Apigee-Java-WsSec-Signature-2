...
public abstract class CalloutTestBase {
  ...
  static final String misplacedSecurityHeader =
      "<s:Envelope\n"
          ...
          + "     xmlns:ns1=\"http://webservices.example.com/services\">\n"
          + "   <s:Header>\n"
          + "      <ns1:AuthHeader>\n"
          + "         <ns1:HomeID>88850083</ns1:HomeID>\n"
          + "         <wssec:Security>\n"
          + "            <wssec:UsernameToken>\n"
          + "              <wssec:Username>redacted</wssec:Username>\n"
          + "              <wssec:Password>redacted</wssec:Password>\n"
          + "            </wssec:UsernameToken>\n"
          + "        </wssec:Security>\n"
          + "      </ns1:AuthHeader>\n"
          + "   </s:Header>\n"
          + "   <s:Body>\n"
          + "      <ns1:GetContacts>\n"
          + "         <ns1:RqUID>GettingContactWithNickName222</ns1:RqUID>\n"
          + "      </ns1:GetContacts>\n"
          + "   </s:Body>\n"
          + "</s:Envelope>\n";
