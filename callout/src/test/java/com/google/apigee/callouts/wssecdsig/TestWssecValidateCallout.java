...
public class TestWssecValidateCallout extends CalloutTestBase {
  ...
  private static final String signedSoapWithExpiry1 =
      "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\""
          ...
          + "  <soapenv:Header><wssec:Security soapenv:mustUnderstand=\"1\"><wsu:Timestamp"
          + " wsu:Id=\"Timestamp-1a955a57-6e37-4b00-be3b-8bb6cb53a55e\"><wsu:Created>2019-10-11T22:54:33Z</wsu:Created><wsu:Expires>2019-10-11T23:09:33Z</wsu:Expires></wsu:Timestamp><wssec:BinarySecurityToken"
          ...
          + " URI=\"#Body-e30cad12-ff22-442f-b54c-d0e091207651\"><Transforms><Transform"
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/></Transforms><DigestMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#sha1\"/><DigestValue>xyRKsY2Yg0I/yFvG1M8Mh1RMu7s=</DigestValue></Reference><Reference"
          + " URI=\"#Timestamp-1a955a57-6e37-4b00-be3b-8bb6cb53a55e\"><Transforms><Transform"
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/></Transforms><DigestMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#sha1\"/><DigestValue>iQAv8Jkh8m8uBERX+0Gd5E5ZG08=</DigestValue></Reference></SignedInfo><SignatureValue>MBhXR0N5jVHADW4IWFTPOY0g4HNgp5IGrtU2stfGDhJ1B6UJ5YMTqnCDtDnz/S4csFmk+3yxqaoG\n"
          ...
          + "4t+ONqa+UwC8sttkz+le4y15kfJhAxkOR+swTw==</SignatureValue><KeyInfo><wssec:SecurityTokenReference><wssec:Reference"
          + " URI=\"#SecurityToken-97001b67-5f40-4bc1-8be3-c7deec352ce7\""
          + " ValueType=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-x509-token-profile-1.0#X509v3\"/></wssec:SecurityTokenReference></KeyInfo></Signature></wssec:Security></soapenv:Header><soapenv:Body"
          + " wsu:Id=\"Body-e30cad12-ff22-442f-b54c-d0e091207651\">    <ns1:sumResponse>     "
          + " <ns1:return>9</ns1:return>    </ns1:sumResponse>  </soapenv:Body></soapenv:Envelope>";
  ...
  private static final String signedSoapNoExpiry1 =
      "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\""
          ...
          + " xmlns:wsu=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd\">"
          + "  <soapenv:Header><wssec:Security soapenv:mustUnderstand=\"1\"><wsu:Timestamp"
          + " wsu:Id=\"Timestamp-2360297c-f9aa-4eee-8d77-18dc879e5c96\"><wsu:Created>2019-10-10T03:11:33Z</wsu:Created></wsu:Timestamp><wssec:BinarySecurityToken"
          + " EncodingType=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-soap-message-security-1.0#Base64Binary\""
          + " ValueType=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-x509-token-profile-1.0#X509v3\""
          ...
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/><SignatureMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#rsa-sha1\"/><Reference"
          + " URI=\"#Body-2b0a6efc-3595-4400-a86d-2ec647f47a1c\"><Transforms><Transform"
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/></Transforms><DigestMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#sha1\"/><DigestValue>cXimEY2UdfeKiEBzpd5hQn5DwG8=</DigestValue></Reference><Reference"
          + " URI=\"#Timestamp-2360297c-f9aa-4eee-8d77-18dc879e5c96\"><Transforms><Transform"
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/></Transforms><DigestMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#sha1\"/><DigestValue>i2VsQBraiZBSj91G1Y/5gd+B9io=</DigestValue></Reference></SignedInfo><SignatureValue>EDRJmfWQ6cQ0OcHAvB1fLLMYsbyGIUxwroYkyZ4EXvY+T6n9vi5YJ78dss6WDDtOvwBpO5drzqou\n"
          ...
          + "0euQAtNitxzpea3NxhB2q4B+W2ufMMAxFnS1zA==</SignatureValue><KeyInfo><wssec:SecurityTokenReference><wssec:Reference"
          + " URI=\"#SecurityToken-fc17c566-ca8f-4dc1-8831-5b7229308ea3\""
          + " ValueType=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-x509-token-profile-1.0#X509v3\"/></wssec:SecurityTokenReference></KeyInfo></Signature></wssec:Security></soapenv:Header><soapenv:Body"
          + " wsu:Id=\"Body-2b0a6efc-3595-4400-a86d-2ec647f47a1c\">    <ns1:sumResponse>     "
          + " <ns1:return>9</ns1:return>    </ns1:sumResponse> "
  ...
  private static final String signedSoapMissingSecurityTokenReference =
      "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?><soapenv:Envelope"
          ...
          + " xmlns:wsu=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd\">"
          + "  <soapenv:Header><wssec:Security soapenv:mustUnderstand=\"1\"><wsu:Timestamp"
          + " wsu:Id=\"Timestamp-b00f0f15-50d6-4e50-8841-38f9b3ae01cb\"><wsu:Created>2019-10-08T03:39:39Z</wsu:Created></wsu:Timestamp><Signature"
          + " xmlns=\"http://www.w3.org/2000/09/xmldsig#\"><SignedInfo><CanonicalizationMethod"
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/><SignatureMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#rsa-sha1\"/><Reference"
          + " URI=\"#Body-61274408-e24e-4df6-b1ec-612538ced7e6\"><Transforms><Transform"
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/></Transforms><DigestMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#sha1\"/><DigestValue>5zMKTwWym107y+YwQoTmfiy6LqM=</DigestValue></Reference><Reference"
          + " URI=\"#Timestamp-b00f0f15-50d6-4e50-8841-38f9b3ae01cb\"><Transforms><Transform"
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/></Transforms><DigestMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#sha1\"/><DigestValue>SF8XRy854rxcfjgYn4sCt5IkMfw=</DigestValue></Reference></SignedInfo><SignatureValue>ksG/4U2hyJfgxIhekbLE8tXJ1/QCg7MhZuYoNnNIKj1jibBfDHkAo/p1XhYjMvZHdK7pR1XWvhDu\n"
          ...
          + "5SJ1ITs+peOCYjhVZvdngyCP9YNDtsLZftMLoQ==</Modulus><Exponent>AQAB</Exponent></RSAKeyValue></KeyValue></KeyInfo></Signature></wssec:Security></soapenv:Header><soapenv:Body"
          + " wsu:Id=\"Body-61274408-e24e-4df6-b1ec-612538ced7e6\">    <ns1:sumResponse>     "
          + " <return>9</return>    </ns1:sumResponse>  </soapenv:Body></soapenv:Envelope>\n";
  ...
  private static final String signedSoapWithIssuerSerial =
      "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\""
          ...
          + " xmlns:ns1=\"http://ws.example.com/\">\n"
          + "  <soapenv:Header><wssec:Security soapenv:mustUnderstand=\"1\"><wsu:Timestamp"
          + " wsu:Id=\"Timestamp-466b8e6a-5404-403d-a12f-94aee405760d\"><wsu:Created>2019-11-21T17:31:40Z</wsu:Created><wsu:Expires>2019-11-21T17:36:40Z</wsu:Expires></wsu:Timestamp><Signature"
          + " xmlns=\"http://www.w3.org/2000/09/xmldsig#\"><SignedInfo><CanonicalizationMethod"
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/><SignatureMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#rsa-sha1\"/><Reference"
          + " URI=\"#Body-b8ec95ca-c7f1-497d-afdf-1144d98fe068\"><Transforms><Transform"
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/></Transforms><DigestMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#sha1\"/><DigestValue>B83bgub0iAcsd39NYb3J2bpV2FU=</DigestValue></Reference><Reference"
          + " URI=\"#Timestamp-466b8e6a-5404-403d-a12f-94aee405760d\"><Transforms><Transform"
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/></Transforms><DigestMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#sha1\"/><DigestValue>RI6KMtZmnkirtnYqxqhuDrzBF70=</DigestValue></Reference></SignedInfo><SignatureValue>fOtgpaZyN1cGJa4JdNzKpYvgz/8tb28us/zbqEyAfDdmd+JhP2IjLpNf+x8+M5TtsNlMc16ta6/W\n"
  ...
  private static final String signedSoapWithKeyInfoRawCert =
      "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\""
          ...
          + " xmlns:ns1=\"http://ws.example.com/\">\n"
          + "  <soapenv:Header><wssec:Security soapenv:mustUnderstand=\"1\"><wsu:Timestamp"
          + " wsu:Id=\"Timestamp-c4a1b3a5-57fa-4747-a27c-7534c0b29c34\"><wsu:Created>2019-11-21T19:24:55Z</wsu:Created></wsu:Timestamp><Signature"
          + " xmlns=\"http://www.w3.org/2000/09/xmldsig#\"><SignedInfo><CanonicalizationMethod"
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/><SignatureMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#rsa-sha1\"/><Reference"
          + " URI=\"#Body-92bdb04f-e124-479a-9978-9220ac84130b\"><Transforms><Transform"
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/></Transforms><DigestMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#sha1\"/><DigestValue>BZYaq3hrrIF7l520PV3VTu3rTJ0=</DigestValue></Reference><Reference"
          + " URI=\"#Timestamp-c4a1b3a5-57fa-4747-a27c-7534c0b29c34\"><Transforms><Transform"
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/></Transforms><DigestMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#sha1\"/><DigestValue>H4B7MvA3pQO3ZxUe1d6w5fK/ErM=</DigestValue></Reference></SignedInfo><SignatureValue>eiPSfxLQbeQ9NUCuEpVY6aio6ClivAH9jAyAyJD033KQba9mCZelaKlLfg+1Q6jiaTOPjN3mx9ZX\n"
  ...
  private static final String signedSoapWithKeyInfoThumbprint =
      "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\""
          ...
          + " xmlns:ns1=\"http://ws.example.com/\">\n"
          + "  <soapenv:Header><wssec:Security soapenv:mustUnderstand=\"1\"><wsu:Timestamp"
          + " wsu:Id=\"Timestamp-0bdbc910-099a-4e32-96e1-7391cbc5d23b\"><wsu:Created>2019-11-21T19:22:23Z</wsu:Created><wsu:Expires>2019-11-21T19:27:23Z</wsu:Expires></wsu:Timestamp><Signature"
          + " xmlns=\"http://www.w3.org/2000/09/xmldsig#\"><SignedInfo><CanonicalizationMethod"
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/><SignatureMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#rsa-sha1\"/><Reference"
          + " URI=\"#Body-6ae8814d-7a91-41ec-8261-ff177c245752\"><Transforms><Transform"
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/></Transforms><DigestMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#sha1\"/><DigestValue>sTtJdgJQ7c+RJePuNjrRxtgYyM4=</DigestValue></Reference><Reference"
          + " URI=\"#Timestamp-0bdbc910-099a-4e32-96e1-7391cbc5d23b\"><Transforms><Transform"
          + " Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/></Transforms><DigestMethod"
          + " Algorithm=\"http://www.w3.org/2000/09/xmldsig#sha1\"/><DigestValue>ZBN/UnJDJzAfwm1zMe2beUyPInM=</DigestValue></Reference></SignedInfo><SignatureValue>Kt4b1P/vC+TkzLho7LtM965U/n+X445cTesn7JAq7Q3wjvqdqKYM+MCDNP9P1yuVD7bdVpoGhcs6\n"
          ...
          + "nNLI+3gJTyMo7xXe2Yve2SNWov05trRJcwH1bQ==</SignatureValue><KeyInfo><wssec:SecurityTokenReference><wssec:KeyIdentifier"
          + " ValueType=\"http://docs.oasis-open.org/wss/oasis-wss-soap-message-security1.1#ThumbprintSHA1\">raOpRmaa1ObiyfgTYMMknkmlen0=</wssec:KeyIdentifier></wssec:SecurityTokenReference></KeyInfo></Signature></wssec:Security></soapenv:Header><soapenv:Body"
          + " wsu:Id=\"Body-6ae8814d-7a91-41ec-8261-ff177c245752\">\n"
          + "    <ns1:sumResponse>\n"
          + "      <ns1:return>9</ns1:return>\n"
          + "    </ns1:sumResponse>\n"
          + "  </soapenv:Body>\n"
  ...
  public void redundantAcceptableThumbprints() throws Exception {
    ...
    props.put(
        ...
        "ef3712c45743b3f4405f597a1f6173c4c7d0992eda38c0a3a42983d91a2cf489");
    props.put("source", "message.content");
    ...
    Assert.assertEquals(
        errorOutput,
        "you should specify only one of acceptable-thumbprints or acceptable-thumbprints-sha256");
  }
  ...
  public void emptyDoc() throws Exception {
    ...
    Object errorOutput = msgCtxt.getVariable("wssec_error");
    Assert.assertNotNull(errorOutput, "errorOutput");
    Assert.assertEquals(errorOutput, "Premature end of file.");
  ...
  public void subjectNameMatch() throws Exception {
    ...
    props.put(
        "accept-subject-cns", "apigee.google.com, abc.example.com"); // one of these names matches
  ...
  public void viaThumbprintAndExternalCert_Fail() throws Exception {
    ...
    Object errorOutput = msgCtxt.getVariable("wssec_error");
    Assert.assertEquals(
        errorOutput, "KeyInfo/SecurityTokenReference/KeyIdentifier thumbprint mismatch");
  ...
  @Test
  public void misplacedSecHeader_PlacementIgnored() throws Exception {
    String method = "misplacedSecHeader_PlacementIgnored() ";
    msgCtxt.setVariable("message.content", misplacedSecurityHeader);
    msgCtxt.setVariable("my-private-key", pairs[2].privateKey);
    msgCtxt.setVariable("my-certificate", pairs[2].certificate);
    ...
    props2.put("accept-thumbprints", "ada3a946669ad4e6e2c9f81360c3249e49a57a7d");
    props2.put("require-expiry", "false");
    props2.put("ignore-security-header-placement", "true");
    props2.put("source", "signed-document");
